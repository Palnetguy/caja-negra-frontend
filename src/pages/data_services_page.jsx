        ...
        <div className="data_services">
            <div className="top">
                ...
                <div className="info">
                    ...
                    <p>En Caja Negra, comprendemos la importancia de los datos en el mundo digital actual. Ofrecemos soluciones avanzadas de análisis y gestión de datos para ayudarte a aprovechar al máximo la información disponible. Ya sea que busques optimizar tus operaciones, entender mejor a tus clientes o descubrir nuevas oportunidades de crecimiento, nuestros servicios de datos están diseñados para brindarte las herramientas y conocimientos necesarios.</p>
                </div>
            </div>
            <div className="more">
                <DataServices />
      ...
      <div className="data_services_op">
        ...
        <div className="data_serv_container">
            ...
            <div className="data_serv">
                ...
                <p>Análisis descriptivo
                    Análisis predictivo
                    Análisis prescriptivo
                    Análisis de datos en tiempo real
                </p>
                <button className="full_gradient_btn">
                    Solicitar
                </button>
            </div>
            <div className="data_serv">
                <h1>Inteligencia de Negocios (BI)</h1>
                <p>Desarrollo de paneles de control 
            ...
            <div className="data_serv">
                <h1>Big Data</h1>
                <p>Almacenamiento y gestión de grandes volúmenes de datos
            ...
            <div className="data_serv">
                ...
                <p>ntegración de datos de múltiples fuentes
                    Migración de datos
            ...
            <div className="data_serv">
                ...
                <p>Extracción de patrones y tendencias
            ...
            <div className="data_serv">
                ...
                <p>Diseño y desarrollo de almacenes de datos
            ...
            <div className="data_serv">
                ...
                <p>Protección de datos y ciberseguridad
                    Cumplimiento de normativas y regulaciones de datos
            ...
            <div className="data_serv">
                ...
                <p>Políticas y procedimientos de datos
            ...
            <div className="data_serv">
                ...
                <p>Desarrollo de modelos predictivos
            ...
            <div className="data_serv">
                ...
                <p>Evaluación de estrategias de datos existentes
                    Desarrollo de hojas de ruta de datos
            ...
            <div className="data_serv">
                ...
                <p>Creación de informes visuales interactivos
                    Diseño de visualizaciones atractivas y efectivas
                    Presentación de datos complejos de manera accesible
                </p>
                <button className="full_gradient_btn">
                    Solicitar
                </button>
            ...
            <div className="data_serv">
                ...
                <p>Automatización de flujos de trabajo de datos
