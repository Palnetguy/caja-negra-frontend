        ...
        <div className="register_domino">
            <div className="top">
                ...
                <div className="info">
                    ...
                    <h1>DOMINIO</h1>
                    <p>
                        Asegura el nombre de dominio perfecto con nosotros
                    </p>
        ...
        <div className="register_domino_op">
            ...
            <div className="register_domino_op_container">
                <div className="register_domin_each">
                    ...
                    <p>Utilice nuestra herramienta de búsqueda de precios de dominios y ahorre dinero.</p>
                </div>
                <div className="register_domin_each">
                    <div className="image">
    ...
    return ( 
        <div className="domains">
            ...
            <div className="more_domain">
                <h2 className="sub_title">Estamos aquí para apoyar su viaje en línea</h2>
